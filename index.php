...
function simpleMsg() {
   return "Here is a simple message";
}
...
<body>
    <main>
        ...
        <ol>
            ...
            <li id="2"><?php echo ($y > 5) ? "y is greater than 5" : "y is less than or equal to 5"; ?></li>
            <li id="3"><?php 
                  if ($z > 5) echo "z is greater than 5"; 
                  elseif ($z === 5) echo "z is equal to 5"; 
                  else echo "z is less than 5"; 
            ?></li>
            <li id="4"><?php 
                     switch ($w) {
                     case "sunny": echo "Great weather!"; break;
                     case "cloudy": echo "Bad weather"; break;
                     default: echo "Average weather";
                     }
            ?></li>
            <li id="5"><?php 
                     switch ($grade) {
                        case "9": echo "Freshman"; break;
                        case "10": echo "Sophomore"; break;
                        case "11": echo "Junior"; break;
                        case "12": echo "Senior"; break;
